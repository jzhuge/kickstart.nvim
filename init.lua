...
do
  ...
  vim.keymap.set('n', '<leader>e', function() vim.diagnostic.open_float(nil, { focusable = false }) end, { desc = 'Open floating diagnostic message' })
...
do
  ...
  -- Colorscheme is set by auto-dark-mode based on macOS appearance.
